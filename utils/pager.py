...
class Pagination(object):
    ...
    def bootstrap_page_html(self):
        ...
        if self.current_page == pager_start:
            top_page = '<li class="disabled"><span  href="%s?%s" >上一页</span></li>' % (
                self.base_url, self.params.urlencode(),)
        else:
            top_page = '<li><a href="%s?%s">上一页</a></li>' % (self.base_url, self.params.urlencode(),)
        page_html_list.append(top_page)
        ...
        if self.current_page == pager_end:
            lower_page = '<li class="disabled"><span  href="%s?%s" >下一页</span></li>' % (
                self.base_url, self.params.urlencode(),)
        else:
            lower_page = '<li><a  href="%s?%s" >下一页</a></li>' % (self.base_url, self.params.urlencode(),)
        page_html_list.append(lower_page)
