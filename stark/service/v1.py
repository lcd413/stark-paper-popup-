...
class StarkConfig(object):
    ...
    def edit(self, obj=None, is_header=False):
        ...
        if query_str:
            ...
            return mark_safe(
                '<a href="%s?%s">编辑</a>' % (self.get_change_url(obj.pk), params.urlencode(),))  # /stark/app01/userinfo/
        return mark_safe('<a href="%s">编辑</a>' % (self.get_change_url(obj.pk),))  # /stark/app01/userinfo/
